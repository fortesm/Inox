...
run_llvm_emission_test "$repo_root/examples/llvm-integer-function.inox" \
    "define i64 @inox_sum" "%tmp0 = add i64 %a, %b" "ret i64 %tmp0" "define i32 @main()" "ret i32 0"
...
run_llvm_emission_test "$repo_root/examples/llvm-local-variables.inox" \
    "define i64 @inox_compute" "%a = alloca i64" "%b = alloca i64" "store i64 10, ptr %a" "store i64 20, ptr %b" "load i64, ptr %a" "load i64, ptr %b" "add i64" "ret i64" "define i32 @main()" "ret i32 0"
...
run_llvm_emission_test "$repo_root/examples/llvm-local-assignment.inox" \
    "define i64 @inox_compute" "%a = alloca i64" "%b = alloca i64" "store i64 10, ptr %a" "store i64 20, ptr %b" "add i64" "mul i64" "store i64 %tmp0, ptr %a" "store i64 %tmp3, ptr %b" "ret i64" "define i32 @main()" "ret i32 0"
run_llvm_emission_test "$repo_root/examples/llvm-integer-operators.inox" \
    "define i64 @inox_compute" "%tmp0 = sdiv i64 %a, %b" "srem i64" "shl i64" "ashr i64" "and i64" "or i64" "xor i64" "ret i64" "define i32 @main()" "ret i32 0"
...
run_llvm_emission_test "$repo_root/examples/llvm-if-merge.inox" \
    "define i64 @inox_maxplusone" "%m = alloca i64" "icmp sgt i64" "br i1" "label %then0" "label %else0" "then0:" "else0:" "br label %endif0" "endif0:" "store i64" "load i64" "add i64" "ret i64" "define i32 @main()" "ret i32 0"
run_llvm_emission_test "$repo_root/examples/llvm-while-loop.inox" \
    "define i64 @inox_sumto" "whilecond0:" "whilebody0:" "whileend0:" "br i1" "br label %whilecond0" "icmp sgt i64" "add i64" "sub i64" "ret i64" "define i32 @main()" "ret i32 0"
run_llvm_emission_test "$repo_root/examples/llvm-while-break-continue.inox" \
    "define i64 @inox_findfirstbelow" "whilecond0:" "whilebody0:" "whileend0:" "br i1" "br label %whilecond0" "br label %whileend0" "icmp eq i64" "sub i64" "store i64" "ret i64" "define i32 @main()" "ret i32 0"
...
run_llvm_emission_test "$repo_root/examples/llvm-repeat-break-continue.inox" \
    "define i64 @inox_findvalue" "repeatbody" "repeatend" "br i1" "br label" "icmp eq i64" "sub i64" "store i64" "ret i64" "define i32 @main()" "ret i32 0"
run_llvm_emission_test "$repo_root/examples/llvm-for-range-break-continue.inox" \
    "define i64 @inox_sumrange" "forcond" "forbody" "forstep" "forend" "br i1" "br label" "icmp sle i64" "icmp eq i64" "add i64" "store i64" "load i64" "ret i64" "define i32 @main()" "ret i32 0"
run_llvm_emission_test "$repo_root/examples/llvm-for-range-step.inox" \
    "define i64 @inox_sumevenuntil" "forcond" "forbody" "forstep" "forend" "store i64 2, ptr %i" "icmp sle i64" "icmp eq i64" "add i64" ", 2" "br i1" "br label" "ret i64" "define i32 @main()" "ret i32 0"
...
run_llvm_emission_test "$repo_root/examples/llvm-struct-basic.inox" \
    "%tpoint = type { i64, i64 }" "define i64 @inox_sumpoint" "alloca %tpoint" "zeroinitializer" "getelementptr %tpoint" "store i64 10" "store i64 20" "load i64" "add i64" "call i64 @inox_sumpoint" "ret i32 0"
...
run_llvm_emission_test "$repo_root/examples/with-statement.inox" \
    "%tpoint = type { i64, i64 }" "define i64 @inox_sumpoint" "alloca %tpoint" "getelementptr %tpoint" "store i64 10" "store i64 20" "load i64" "add i64" "call i64 @inox_sumpoint" "ret i32 0"
